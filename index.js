		...
		try {
			...
			switch(command) {
				...
				case 'sticker':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								client.sendMessage(from, fs.readFileSync(ran), smedia)
								fs.unlinkSync(ran)
							})
							.addOutputOptions([`-vcodec`,`libwebp`,`-vf`,`scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
							.toFormat('webp')
				...
				case 'belle':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '👀︄1�7'})
					break
				case 'belle1':
					memein = await kagApi.memeindo()
				...
				case 'lofi':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️💄1�7'})
					break
				case 'malkova':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '︄1�7*canal do dark:*\n\n https://bit.ly/3omUNCg'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
				...
				case 'nsfwloli':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Rum︄1�7'})
					break
				case 'reislin':
					memein = await kagApi.memeindo()
				...
				case 'mia2':
					...
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'use o .sticker para ver o gif da mia︄1�7'})
					break
				case 'memeindo':
					memein = await kagApi.memeindo()
...
case 'teste':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/gallery/ecIt5`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Bom dia, vcs sao fodas ❤️'})
					break
